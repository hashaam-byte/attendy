...
import { Users, UserCheck, UserX, Clock, TrendingUp, Scan } from 'lucide-react'
...
export default async function DashboardPage({
  ...
  const stats = [
    { label: 'Total Students', value: totalStudents, icon: Users, color: 'blue', sub: 'enrolled' },
    { label: 'Present Today', value: presentToday, icon: UserCheck, color: 'green', sub: `${attendanceRate}% rate` },
    { label: 'Absent Today', value: absentToday, icon: UserX, color: 'red', sub: 'not scanned' },
    { label: 'Late Today', value: lateToday, icon: Clock, color: 'yellow', sub: 'after cutoff' },
  ]
    ...
    <>
      <style>{`
        ...
        .stat-card::after {
          ...
          height: 2px;
          background: var(--stat-color, #00e676);
          opacity: 0.6;
        }
      ...
      <div className="stats-grid">
        {stats.map(({ label, value, icon: Icon, color, sub }) => {
          ...
          return (
            <div className="stat-card" key={label} style={{ '--stat-color': c.dot } as any}>
