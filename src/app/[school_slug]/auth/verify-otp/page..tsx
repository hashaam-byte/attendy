...
export default function VerifyOtpPage() {
  ...
  // Stage 1: User enters email to request/resend OTP
  async function handleEmailSubmit() {
    ...
    if (otpError) {
      ...
      if (otpError.message.toLowerCase().includes('user') || otpError.status === 422) {
  ...
  async function handleOtpSubmit() {
    ...
    // Fetch their profile to get name and school info
  ...
  // OTP input: auto-advance when 6 digits entered
  ...
  return (
    <div className="vp-root">
      <style>{`
        ...
        .vp-btn:disabled { opacity: 0.5; cursor: not-allowed; transform: none; box-shadow: none; }
        ...
        .vp-done-title {
          ...
          color: #e2ece6; margin-bottom: 8px;
        }
        ...
        .vp-footer a {
          color: #5a7060; text-decoration: none;
        }
          ...
          <div className="vp-body">
            ...
            {stage === 'email' && (
              <>
                ...
                <div className="vp-subtitle">
                  Your school admin has added you to <strong>{schoolName}</strong>. Enter your work email to receive a verification code.
                </div>
                {error && (
            ...
            {stage === 'otp' && (
              <>
                ...
                <div className="vp-info">
                  Check your <strong>spam/junk folder</strong> if you don't see it within a minute. The sender will be from Supabase on behalf of Attendy.
                </div>
                {error && (
                  <div className="vp-error">
                    <AlertCircle size={14} style={{ flexShrink: 0, marginTop: 1 }} />
            ...
            {stage === 'password' && (
              <>
                ...
                <div className="vp-subtitle">
                  You've been verified as staff at <strong>{schoolInfo?.name ?? schoolName}</strong>. Set a password to complete your account setup.
                </div>
                {error && (
                  <div className="vp-error">
                    <AlertCircle size={14} style={{ flexShrink: 0, marginTop: 1 }} />
